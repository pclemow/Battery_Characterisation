...
bms_filename = "./Data/Battery_Full_Charge_170926.csv"
...
while(testing):
    ...
    if BMS_mainloop == 1:
        timenow = datetime.now().strftime("%H:%M:%S")
        print(timenow + "Entering CC charge phase at 1C")
        cccv_charge(c_nom, 1, bms_filename)
        timenow = datetime.now().strftime("%H:%M:%S")
        print("\n" + timenow + "Done with CC charge")
        print("Resting for 5 Mins")
        rest_battery(300,1, bms_filename)
        
        timenow = datetime.now().strftime("%H:%M:%S")
        print(timenow + "Entering CC charge phase at C/2")
        cccv_charge(c_nom/2,1, bms_filename)
        timenow = datetime.now().strftime("%H:%M:%S")
        print("\n" + timenow + "Done with CC charge")
        print("Resting for 5 Mins")
        rest_battery(300,1, bms_filename)
        ...
        timenow = datetime.now().strftime("%H:%M:%S")
        print(timenow + "Entering CC charge phase at C/4")
        cccv_charge(c_nom/4,1, bms_filename)
        timenow = datetime.now().strftime("%H:%M:%S")
        print("\n" + timenow + "Done with CC charge")
        print("Resting for 5 Mins")
        rest_battery(300,1, bms_filename)
        ...
        timenow = datetime.now().strftime("%H:%M:%S")
        print(timenow + "Entering CC charge phase at C/8")
        cccv_charge(c_nom/8,1, bms_filename)
        timenow = datetime.now().strftime("%H:%M:%S")
        print("\n" + timenow + "Done with CC charge")
        print("Resting for 5 Mins")
        rest_battery(300,1, bms_filename)
        ...
        timenow = datetime.now().strftime("%H:%M:%S")
        print(timenow + "Entering CC charge phase at C/16")
        cccv_charge(c_nom/16,1, bms_filename)
        timenow = datetime.now().strftime("%H:%M:%S")
        print("\n" + timenow + "Done with CC charge")
        print("Resting for 5 Mins")
        rest_battery(300,1, bms_filename)
